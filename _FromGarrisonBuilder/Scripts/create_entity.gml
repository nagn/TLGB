...

{
  ...
  switch(argument2) {
    ...
    break;    
    case "redspawn1":
      new_ent.sprite_index = redspawn1_ent;
    break;    
    case "redspawn2":
      new_ent.sprite_index = redspawn2_ent;
    break;  
    case "redspawn3":
      new_ent.sprite_index = redspawn3_ent;
    break; 
    case "redspawn4":
      new_ent.sprite_index = redspawn4_ent;
    break;    
    case "bluespawn1":
      new_ent.sprite_index = bluespawn1_ent;
    break;    
    case "bluespawn2":
      new_ent.sprite_index = bluespawn2_ent;
    break;  
    case "bluespawn3":
      new_ent.sprite_index = bluespawn3_ent;
    break; 
    case "bluespawn4":
      new_ent.sprite_index = bluespawn4_ent;
    break;  
    case "KothControlPoint":
      new_ent.sprite_index = KothControlPoint_ent;
    break;
    case "MoveBoxUp":
      new_ent.sprite_index = MoveBoxUp_ent;
    break;
    case "MoveBoxDown":
      new_ent.sprite_index = MoveBoxDown_ent;
    break;
    case "MoveBoxLeft":
      new_ent.sprite_index = MoveBoxLeft_ent;
    break;
    case "MoveBoxRight":
      new_ent.sprite_index = MoveBoxRight_ent;
    break;
    case "KothRedControlPoint":
      new_ent.sprite_index = KothRedControlPoint_ent;
    break;
    case "KothBlueControlPoint":
      new_ent.sprite_index = KothBlueControlPoint_ent;
    break;
    case "leftdoor":
      new_ent.sprite_index = leftdoor_ent;
    break;
    case "rightdoor":
      new_ent.sprite_index = rightdoor_ent;
    break;
    default:
